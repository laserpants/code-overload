...
In this context, conventional (non-functional) programming languages (C, C++, Java, etc.) are often referred to as *imperative*, or prescriptive languages. Intuitively, we may think of the difference as,
